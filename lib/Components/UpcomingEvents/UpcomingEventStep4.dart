...
class UpcomingEventStep4 extends StatelessWidget {
  UpcomingEventStep4({Key? key}) : super(key: key);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                RichText(
                    text: TextSpan(
                  text: 'Pre-enrolled Boat Mfg Incentive Program? ',
                  style: DefaultTextStyle.of(context).style,
                  children: const <TextSpan>[
                    TextSpan(text: '*', style: TextStyle(color: requiredColor)),
                  ],
              ...
              children: [
                ...
                Container(
                  ...
                  child: RichText(
                      text: TextSpan(
                    text:
                        "By registering, you confirm to have read and agree to both ",
